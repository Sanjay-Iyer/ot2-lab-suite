...
CONFIG = {
    ...
    "dilution": {
        ...
        "mix_reps": 3,
        "mix_volume_ul": 120.0,
        # ⚠ ORDER MATTERS: tips allocated A-first from the first column; the very
        # first tip becomes the water-only pass tip. See YAML for full explanation.
    ...
    "printing": {
        ...
        "replicate_spacing_mm": {"x": 12.0, "y": 0.0, "z": 0.0},
