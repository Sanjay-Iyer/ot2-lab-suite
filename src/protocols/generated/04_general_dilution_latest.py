...
CONFIG = { 'protocol_label': 'prepare_c11_d11_5x',
  'deck': { 'stock': { 'slot': 1,
  ...
  'stock': {'well': 'A11', 'material': 'concentrated dye', 'aspirate_height_mm': 0.5},
  'diluent': {'well': 'A1', 'material': 'water', 'aspirate_height_mm': 4.0},
  'destination': {'wells': ['C11', 'D11'], 'dispense_height_mm': 2.0, 'aspirate_height_mm': 0.5},
  'dilution': { 'mode': 'single',
                'stock_volume_ul': 60.0,
                'diluent_volume_ul': 240.0,
