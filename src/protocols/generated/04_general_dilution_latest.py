...
CONFIG = { 'protocol_label': 'general_dilution',
  'deck': { 'stock': { 'slot': 7,
  ...
  'stock': {'well': 'A1', 'material': 'stock', 'aspirate_height_mm': 4.0},
  'diluent': {'well': 'A2', 'material': 'water', 'aspirate_height_mm': 4.0},
  'destination': {'wells': ['B11'], 'dispense_height_mm': 2.0, 'aspirate_height_mm': 1.0},
