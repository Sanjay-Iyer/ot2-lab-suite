...
CONFIG = { 'protocol_label': 'a11_paper5_column10_height_sweep',
  'deck': { 'source': { 'slot': 1,
  ...
  'print_groups': [ { 'source_well': 'A11',
                      'targets': ['A10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.3,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['B10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.4,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['C10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.5,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['D10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.6,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['E10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.7,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['F10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.8,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['G10'],
                      'droplets': 1,
                      'dispense_height_mm': 2.9,
                      'source_wells': {'paper': 'A11'}},
                    { 'source_well': 'A11',
                      'targets': ['H10'],
                      'droplets': 1,
