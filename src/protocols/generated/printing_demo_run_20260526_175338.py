    ...
    def capture_image(filename: str) -> None:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                protocol.comment(f"Camera capture failed for {filename}: code {result.returncode}, stderr {result.stderr}")
        except Exception as e:
            protocol.comment(f"Warning: Camera capture exception for {filename}: {e}")
