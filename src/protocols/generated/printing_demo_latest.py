#!/usr/bin/env python3
"""
OT-2 Printing Demo - Robot Protocol (Auto-generated) — 12-Well Variant
Generated by: src/protocols/printing_demo_protocol.py host-side builder.

NOTE: Two parallel protocols now exist:
  protocol_96.py — RECOMMENDED first physical test.
                   Standard opentrons_96_wellplate_200ul_pcr_full_skirt.
                   Safe with p300_multi_gen2. No custom_beta namespace.
  protocol_12.py — EXPERIMENTAL. Custom usascientific12well_12_wellplate_6000ul.
                   Requires manual geometry validation before physical use.

This file (printing_demo_latest.py) is the 12-well variant kept for
historical compatibility. Use protocol_96.py for new physical tests.
...
CONFIG = { 'camera': { 'capture_after': True,
  ...
  'layout': { 'dilution_destination_wells': ['C1', 'C2'],
