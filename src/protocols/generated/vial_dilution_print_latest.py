...
CONFIG = { 'deck': { 'tuberack': { 'load_name': 'tuberack_3dprint_20ml_8vials_v2',
            ...
            'paper': { 'load_name': 'corning_96_wellplate_360ul_custom',
                       ...
                       'version': 1,
                       'slot': 5},
            'tiprack': {'load_name': 'opentrons_96_tiprack_300ul', 'slot': 9},
            'tiprack_p20': {'load_name': 'opentrons_96_tiprack_20ul', 'slot': 2}},
  ...
  'print_groups': [ { 'name': 'coarse_30ul',
                    ...
                    { 'name': 'fine_10ul',
                      ...
                      'pipette': 'p20_single_gen2',
                      'layout': 'single_spot',
                      'source': {'plate_column': '9', 'wells': ['A9', 'B9', 'C9']},
                      'replicates': 2,
                      'destination': { 'paper_start_column': 7,
                                       'spacing_mm': {'x': 9, 'y': 0, 'z': 0}},
                      'dispense': { 'z_mm': 1.0,
                                    'air_gap_ul': 2,
                                    'blow_out': True,
