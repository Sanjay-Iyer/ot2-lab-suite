...
DEFAULT_DO_DILUTION = False  # v8 never dilutes; kept so build flag substitution is uniform
...
CONFIG = {
    ...
    "source": {
        ...
        "park_height_mm": 5.0,
        # Optional re-suspension of the stock before each pass. reps: 0 disables it.
