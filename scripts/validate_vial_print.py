    ...
    return [
        ...
        ("full_run",
         ...
         ["Pre-flight validation passed",
          ...
          "Nozzle layout: SINGLE", "for paper print",
          "Single-tip print source", "Printing 1 droplet onto paper",
          "Returned 8 single print tips", "Demo Completed ==="],
        ...
        ("dry_run",
         ...
         ["Diluting well", "Printing 1 droplet onto paper"]),

        ("dilution_only",
         dict(dry=False, dilution=True, print=False), False, True,
         [f"Diluting well {top_well} to {top_fold:g}x",
          "Dilution series complete", "Demo Completed ==="],
         ["Printing 1 droplet onto paper", "Single-tip print source"]),

        ("print_only",
         dict(dry=False, dilution=False, print=True), False, True,
         ["Single-tip print source", "Printing 1 droplet onto paper", "Demo Completed ==="],
         ["Diluting well"]),
